...
# Initialize all switches we need during boot
switch_mount_usb = init_switch(board.GP1)       # When this switch is pressed during boot, the USB drive will be mounted
switch_autoreload = init_switch(board.GP25)     # When this switch is pressed during boot, the autoreload feature will be enabled (rebooting on every drive change)
