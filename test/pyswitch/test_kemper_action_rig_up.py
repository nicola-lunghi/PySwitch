...
with patch.dict(sys.modules, {
    ...
    from pyswitch.colors import DEFAULT_LABEL_COLOR, DEFAULT_SWITCH_COLOR

    from pyswitch.clients.kemper.actions.rig_up_down import *
    from pyswitch.clients.kemper.actions.rig_select import RIG_SELECT_DISPLAY_CURRENT_RIG, RIG_SELECT_DISPLAY_TARGET_RIG
...
class TestKemperActionDefinitionsRigUp(unittest.TestCase):
    ...
    def test_bank_colors(self):
        ...
        self._test_bank_colors(mapping_value = NUM_BANKS * NUM_RIGS_PER_BANK - 1,    keep_bank = True, exp_color = BANK_COLORS[4], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 125, exp_text_rig = 5)
