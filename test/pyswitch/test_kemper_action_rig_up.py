...
with patch.dict(sys.modules, {
    ...
    from lib.pyswitch.misc import Updater, DEFAULT_LABEL_COLOR, DEFAULT_SWITCH_COLOR
...
class TestKemperActionDefinitionsRigUp(unittest.TestCase):
    ...
    def test_bank_colors(self):
        ...
        self._test_bank_colors(mapping_value = 0,     keep_bank = False, exp_color = BANK_COLORS[0], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 1, exp_text_rig = 2)
        self._test_bank_colors(mapping_value = 1,     keep_bank = False, exp_color = BANK_COLORS[0], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 1, exp_text_rig = 3)
        self._test_bank_colors(mapping_value = 2,     keep_bank = False, exp_color = BANK_COLORS[0], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 1, exp_text_rig = 4)
        self._test_bank_colors(mapping_value = 3,     keep_bank = False, exp_color = BANK_COLORS[0], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 1, exp_text_rig = 5)
        self._test_bank_colors(mapping_value = 4,     keep_bank = False, exp_color = BANK_COLORS[1], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 2, exp_text_rig = 1)
        
        self._test_bank_colors(mapping_value = 5,     keep_bank = False, exp_color = BANK_COLORS[1], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 2, exp_text_rig = 2)
        self._test_bank_colors(mapping_value = 6,     keep_bank = False, exp_color = BANK_COLORS[1], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 2, exp_text_rig = 3)
        self._test_bank_colors(mapping_value = 7,     keep_bank = False, exp_color = BANK_COLORS[1], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 2, exp_text_rig = 4)
        self._test_bank_colors(mapping_value = 8,     keep_bank = False, exp_color = BANK_COLORS[1], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 2, exp_text_rig = 5)
        self._test_bank_colors(mapping_value = 9,     keep_bank = False, exp_color = BANK_COLORS[2], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 3, exp_text_rig = 1)
        ...
        self._test_bank_colors(mapping_value = NUM_BANKS * NUM_RIGS_PER_BANK - 1,    keep_bank = False, exp_color = BANK_COLORS[0], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 126, exp_text_rig = 5)
        ...
        self._test_bank_colors(mapping_value = 0,     keep_bank = True, exp_color = BANK_COLORS[0], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 1, exp_text_rig = 2)
        self._test_bank_colors(mapping_value = 1,     keep_bank = True, exp_color = BANK_COLORS[0], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 1, exp_text_rig = 3)
        self._test_bank_colors(mapping_value = 2,     keep_bank = True, exp_color = BANK_COLORS[0], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 1, exp_text_rig = 4)
        self._test_bank_colors(mapping_value = 3,     keep_bank = True, exp_color = BANK_COLORS[0], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 1, exp_text_rig = 5)
        self._test_bank_colors(mapping_value = 4,     keep_bank = True, exp_color = BANK_COLORS[0], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 1, exp_text_rig = 5)
        
        self._test_bank_colors(mapping_value = 5,     keep_bank = True, exp_color = BANK_COLORS[1], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 2, exp_text_rig = 2)
        self._test_bank_colors(mapping_value = 6,     keep_bank = True, exp_color = BANK_COLORS[1], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 2, exp_text_rig = 3)
        self._test_bank_colors(mapping_value = 7,     keep_bank = True, exp_color = BANK_COLORS[1], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 2, exp_text_rig = 4)
        self._test_bank_colors(mapping_value = 8,     keep_bank = True, exp_color = BANK_COLORS[1], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 2, exp_text_rig = 5)
        self._test_bank_colors(mapping_value = 9,     keep_bank = True, exp_color = BANK_COLORS[1], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 2, exp_text_rig = 5)

        self._test_bank_colors(mapping_value = 10,    keep_bank = True, exp_color = BANK_COLORS[2], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 3, exp_text_rig = 2)

        self._test_bank_colors(mapping_value = NUM_BANKS * NUM_RIGS_PER_BANK - 1,    keep_bank = True, exp_color = BANK_COLORS[0], display_mode = RIG_SELECT_DISPLAY_TARGET_RIG, exp_text_bank = 126, exp_text_rig = 5)
...
############################################################################################################
    ...
    def test_get_next_rig(self):
        ...
        self.assertEqual(get_next_rig(0, 0), 1)
        self.assertEqual(get_next_rig(1, 1), 2)
        self.assertEqual(get_next_rig(2, 2), 3)
        self.assertEqual(get_next_rig(3, 3), 4)
        self.assertEqual(get_next_rig(4, 4), 5)
        
        self.assertEqual(get_next_rig(0, 5), 6)
        self.assertEqual(get_next_rig(1, 6), 7)
        self.assertEqual(get_next_rig(2, 7), 8)
    ...
    def test_get_next_rig_keep_bank(self):
        ...
        self.assertEqual(get_next_rig(2, 2), 3)
        self.assertEqual(get_next_rig(3, 3), 4)
        self.assertEqual(get_next_rig(4, 4), 4)
