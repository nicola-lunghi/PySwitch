...
class Controller {
    ...
    static PYSWITCH_VERSION = "2.4.6";                           // Version of PySwitch this emulator is designed to run with
    static VERSION = Controller.PYSWITCH_VERSION + ".13";        // PySwitch Emulator Version
