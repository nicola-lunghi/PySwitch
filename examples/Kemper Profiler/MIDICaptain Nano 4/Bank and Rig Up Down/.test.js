...
(async function(runner) {
    ...
    // await rigTests.testRigUp(runner.mapping("PA_MIDICAPTAIN_NANO_SWITCH_1"), { keepBank: true, labelTestCoordinates: [1, 1] });
    // await rigTests.testRigDown(runner.mapping("PA_MIDICAPTAIN_NANO_SWITCH_A"), { keepBank: true, labelTestCoordinates: [1, 238] });
})