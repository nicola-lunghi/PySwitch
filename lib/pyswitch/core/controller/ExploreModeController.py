...
class ExploreModeController:
    def __init__(self, config, led_driver):
        ...
        self.led_driver.init(len(available_ports) * FootSwitchDefaults.NUM_PIXELS)
